<?php
	...
	$dates = file_get_contents("secret.txt"); //Возмем все содержание с файла secret.txt
...
";
		...
		file_put_contents("positives.txt", $positives);	//Добавляет сожержимое массива positives в файл positives.txt
		file_put_contents("negatives.txt", $negatives); //Добавляет сожержимое массива negatives в файл negatives.txt
